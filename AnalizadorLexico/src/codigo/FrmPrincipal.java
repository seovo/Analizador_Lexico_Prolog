...
import static codigo.Tokens.Var_anonima;
...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void analizarLexico() throws IOException{
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Var_anonima:
                    resultado += "  <Variable Anonima>\t\t" + lexer.lexeme + "\n";
                    break;
                ...
                case Cadena:
                    ...
                    break;
                case Palabra_clave:
                    resultado += "  <Palabra Clave>\t" + lexer.lexeme + "\n";
                    break;
                case If:
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            ...
            Sintax s2 = new Sintax(new codigo.LexerCup(new StringReader(ST)));
            
            Symbol sym2 = s2.getS();
            String value = sym2.value.toString();
            
            switch (value) {
                case "true":
                    txtAnalizarSin.setText("True");
                    break; 
                case "fail":
                    txtAnalizarSin.setText("False");
                    break;
                default:
